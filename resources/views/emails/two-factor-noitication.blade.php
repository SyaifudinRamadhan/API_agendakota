                                                        ...
                                                        <td class="o_btn-b o_heading o_text-xs" align="center"
                                                            ...
                                                            <a class="o_text-light"
                                                                style="text-decoration: none;outline: none;color: #82899a;display: block;padding: 7px 8px;font-weight: bold;"><span
                                                                    style="mso-text-raise: 6px;display: inline;color: #82899a;">{{ $email }}</span>
                            ...
                            <tr>
                                <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center"
                                    ...
                                    <p style="margin-top: 0px;margin-bottom: 0px;">
                                        Gunakan kode OTP berikut melanjutkan Two Factor Authentication sebagai
                                        {{ $username }}
                                    </p>
                                </td>
                            </tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td width="300" class="o_btn o_bg-primary o_br o_heading o_text"
                                                    align="center"
                                                    style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 0px;font-size: 18px;line-height: 24px;mso-padding-alt: 12px 24px;border-radius: 4px;">
                                                    <div
                                                        style="font-size: 18px; padding: 7px; border-radius: 10px; border: 1px solid #ddd";>
                                                        <b>{{ $OTP }}</b>
                                                    </div>
                                                </td>
                                            </tr>
