                                                        ...
                                                        <tr>
                                                            <td class="o_btn-xs o_bg-primary o_br o_heading o_text-xs"
                                                                ...
                                                                <a class="o_text-white"
                                                                    ...
                                                                    style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 7px 16px;mso-text-raise: 3px;">
                                                                    Agendakota</a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                ...
                                <tr>
                                    <td class="o_bg-ultra_light o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light"
                                        ...
                                        <h1 class="o_heading o_text-dark o_mb-xxs"
                                            ...
                                            Service Informations</h1>
                                        <p style="margin-top: 0px;margin-bottom: 0px;">Reminder For You</p>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                                ...
                                <tr>
                                    <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center"
                                        ...
                                        <p style="margin-top: 0px;margin-bottom: 0px;">
                                            <strong>The organizer of event "{{ $eventName }}" that you participated
                                                in, provided the following notification.</strong>
                                        <p style="margin-top: 25px;margin-bottom: 0px;">

                                        </p>
                                        <textarea style="width: 100%; height: 555px; border: 0px">
                                            {!! $mesageContent !!}
                                        </textarea>
                                    </td>
                                </tr>
