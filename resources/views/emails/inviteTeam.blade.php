                ...
                <tr>
                  ...
                  >
                    ...
                    >
                      <tbody>
                        <tr>
                          ...
                          >
                            <img
                              src="{{ $message->embed(public_path('storage').'/images/mail-send-img/record_voice_over-48-primary.png') }}"
                              width="48"
                              height="48"
                              alt=""
                              style="
                    ...
                    <p style="margin-top: 0px; margin-bottom: 0px">
                      ...
                      If you haven't account in this platform, you can login to this platform with this default passwowrd bellow. Ignore this if you have account before.
                    </p>
