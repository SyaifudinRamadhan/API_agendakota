                                                    ...
                                                    <tr>
                                                        <td class="o_btn-xs o_bg-primary o_br o_heading o_text-xs"
                                                            ...
                                                            <a class="o_text-white"
                                                                ...
                                                                style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 7px 16px;mso-text-raise: 3px;">User
                                                                Agendakota</a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                        ...
                        <tbody>
                            <tr>
                                <td class="o_bg-ultra_light o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light"
                                    ...
                                    <p style="margin-top: 0px;margin-bottom: 0px;">User refund request statuses
                                    </p>
                                </td>
                            </tr>
                        </tbody>
                        ...
                        <tbody>
                            <tr>
                                <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center"
                                    ...
                                    <p style="margin-top: 0px;margin-bottom: 0px;">User Notification.
                                        Your refund request statuses with the following data below is
                                        "<b>{{ $statuses }}</b>". <br> {{ $stateMessage }}
                                    </p>
