        ...
        <tbody>
            ...
            ">
                    ...
                    ">
                              ...
                              padding-bottom: 16px;
                            ">
                                                    <img src="{{ $message->embed(public_path('storage') . '/images/mail-send-img/record_voice_over-48-primary.png') }}"
                            ...
                            ">
                                    ...
                                    <h5 class="o_heading o_text-dark o_mb-xxs"
                                        style="
                        font-family: Helvetica, Arial, sans-serif;
                        font-weight: bold;
                        margin-top: 0px;
                      ...
                      ">
                                    ...
                                    <span
                                        style="padding: 5px; border-radius: 5px; background-color: yellow; color: #000; font-size: 12px; font-weight: 500;">Waiting
                                        Payment</span>
                                    <p
                                        style="margin-top: 0px; margin-bottom: 0px; text-align:center; font-size: 13px; line-height: unset;">
                                        {{ $email }}
                                    </p>
                                    <p
                                        style="margin-top: 0px; margin-bottom: 0px; text-align:center; font-size: 13px; line-height: unset;">
                                    ...
                                    <p
                                        style="margin-top: 0px; margin-bottom: 0px; text-align:center; font-size: 13px; line-height: unset; color: #000;">
                                        @if ($virtualAcc)
                                    ...
                                    @if ($virtualAcc)
                                        <p
                                            style="margin-top: 0px; margin-bottom: 0px; text-align:center; font-size: 16px; line-height: unset;">
                                            <b>{{ $virtualAcc }}</b>
                                        </p>
                                    @elseif ($payLink)
                                        <a style="padding: 5px 0px; " href="{{ $payLink }}">
                                            <span
                                                style="padding: 5px; border-radius: 5px; background-color: blue; color: #fff; font-size: 12px; font-weight: 500; border: 0px;">
                                                Bayar Sekarang</span>
                                        </a>
                                    @elseif ($qrStr)
                                        <img style="aspect-ratio: 1; width: 100%; max-width: 100px"
                                            src="{{ $message->embed('data:image/png;base64,' . BarCode2::getBarcodePNG($qrStr, 'QRCODE', 8, 8)) }}"
                                            alt="">
                                    @endif
                                    <p
                                        style="margin-top: 0px; margin-bottom: 0px; text-align:center; font-size: 15px; line-height: unset; color: #000;">
                                        Segera tuntaskan pembayaran anda sebelum {{ $expirationDate }} WIB
                                    </p>
                                </td>
                            </tr>
                        </tbody>
        ...
        <tbody>
            ...
            ">
                    ...
                    <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0"
                      ...
                      width: 45%;
                    ">
                                    <img style="width: 100%; aspect-ratio: 5 / 3; margin-top: 10px;"
                                        src="{{ $message->embed(public_path('') . $eventBanner) }}" alt="">
                                </td>
                                <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center"
                                    style="
                      font-family: Helvetica, Arial, sans-serif;
                    ...
                    ">
                                    <div>
                                        <h5 style="margin-top: 0; margin-bottom: 10px;">{{ $eventName }}</h5>
                    ...
                    <table
                        ...
                        <tr>
                            <td>
                                ...
                                border: 1px dashed #eb597b;
                                border-radius: 10px;
                                margin-bottom: 10px">
                                        <tr>
                                            <td style="padding-right: 10px; width: 23%; min-width: 120px">
                                                <img style="aspect-ratio: 1; width: 100%; max-width: 100px"
                                                    src="{{ $message->embed(public_path('') . $ticket['ticketCover']) }}"
                                                    alt="">
                                            </td>
                                            <td style="font-family: Helvetica, Arial, sans-serif;">
                                                <h6 style="font-size: 13px; margin-top: 0; margin-bottom: 5px;">
                                                    {{ $ticket['ticketName'] }}</h6>
                                                <div style="font-size: 12px; color: #424651;">
                                                    Event / Visit Date : {{ $ticket['ticketDate'] }}
                                                </div>
                                                @if ($ticket['ticketSeatNumber'])
                                                    <div style="font-size: 12px; color: #424651;">
                                                        Seat Number : {{ $ticket['ticketSeatNumber'] }}</div>
                                                @endif
                                            </td>
                                        </tr>
                                    </table>
                    ...
                    ">
                      ...
                      ">
                        ...
                        ">
                                            ...
                                            <p class="o_mb-xs" style="margin-top: 0px; margin-bottom: 8px">
                                                Koridor Co-Working Space, Siola 3rd Floor, Jl. Tunjungan No. 1,
                                                Surabaya
                                            </p>
                                            <p style="margin-top: 0px; margin-bottom: 0px">
                            ...
                            ">Help
                                                    Center</a>
                                                {{-- <span class="o_hide-xs">&nbsp; • &nbsp;</span><br class="o_hide-lg" style="
                              display: none;
                              font-size: 0;
                              max-height: 0;
                              width: 0;
                              ...
                              visibility: hidden;
                            " />
                        <a class="o_text-light o_underline" href="https://example.com/" style="
                              text-decoration: underline;
                              outline: none;
                              color: #82899a;
                            ">Preferences</a>
                      ...
                      ">
                        ...
                        ">
                                            {{-- <p style="margin-top: 0px; margin-bottom: 0px">
                        <a class="o_text-light" href="https://example.com/" style="
                              text-decoration: none;
                              outline: none;
                              color: #82899a;
                            "><img src="images/facebook-light.png" width="36" height="36" alt="fb" style="
                                max-width: 36px;
                                -ms-interpolation-mode: bicubic;
                                vertical-align: middle;
                                border: 0;
                        ...
                        <a class="o_text-light" href="https://example.com/" style="
                              ...
                              outline: none;
                              color: #82899a;
                            "><img src="images/twitter-light.png" width="36" height="36" alt="tw" style="
                                max-width: 36px;
                                -ms-interpolation-mode: bicubic;
                                vertical-align: middle;
                                border: 0;
                        ...
                        <a class="o_text-light" href="https://example.com/" style="
                              ...
                              outline: none;
                              color: #82899a;
                            "><img src="images/instagram-light.png" width="36" height="36" alt="ig" style="
                                max-width: 36px;
                                -ms-interpolation-mode: bicubic;
                                vertical-align: middle;
                                border: 0;
                        ...
                        <a class="o_text-light" href="https://example.com/" style="
                              ...
                              outline: none;
                              color: #82899a;
                            "><img src="images/snapchat-light.png" width="36" height="36" alt="sc" style="
                                max-width: 36px;
                                -ms-interpolation-mode: bicubic;
                                vertical-align: middle;
                                border: 0;
