            ...
            ">
                    ...
                    ">
                      ...
                      ">
                                    ...
                                    <span
                                        style="padding: 5px; border-radius: 5px; background-color: green; color: #fff; font-size: 12px; font-weight: 500;">Payment
                                        Succeeded</span>
                                    <p
                                        ...
                                        <tr>
                                            <td style="padding-right: 10px; width: 23%; min-width: 120px">
                                                <img style="aspect-ratio: 1; width: 100%; max-width: 100px"
                                                    src="{{ $message->embed('data:image/png;base64,' . BarCode2::getBarcodePNG($ticket['ticketQr'], 'QRCODE', 8, 8)) }}"
                                                    alt="">
                                            </td>
                                            <td style="font-family: Helvetica, Arial, sans-serif;">
                                                ...
                                                @endif
                                                <div
                                                    style="font-size: 12px; color: #424651; display: flex; flex-wrap: wrap; gap: 5px; margin-top: 5px;">
                                                    @if ($ticket['downloadLink'])
                                                        <a style="padding: 5px 0px; "
                                                            href="{{ $ticket['downloadLink'] }}">
                                                            <span
                                                                style="padding: 5px; border-radius: 5px; background-color: green; color: #fff; font-size: 12px; font-weight: 500; border: 0px;">Download
                                                                E-Ticket</span>
                                                        </a>
                                                    @endif
                                                    @if ($ticket['joinLink'])
                                                        <a style="padding: 5px 0px;"
                                                            ...
                                                            <span
                                                                style="padding: 5px; border-radius: 5px; background-color: blue; color: #fff; font-size: 12px; font-weight: 500; border: 0px;">Join
                                                                Meet / Zoom</span>
                                                        </a>
                                                    @endif
                                                </div>
