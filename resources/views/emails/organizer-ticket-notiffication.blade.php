                                                    ...
                                                    <tr>
                                                        <td class="o_btn-xs o_bg-primary o_br o_heading o_text-xs"
                                                            ...
                                                            <a class="o_text-white"
                                                                href="https://agendakota.id/admin/finance-report/withdrawals"
                                                                style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 7px 16px;mso-text-raise: 3px;">Admin
                                                                Agendakota</a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                            ...
                            <tr>
                                <td class="o_bg-ultra_light o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light"
                                    ...
                                    <h1 class="o_heading o_text-dark o_mb-xxs"
                                        ...
                                        New Order Notification</h1>
                                    <p style="margin-top: 0px;margin-bottom: 0px;">An user order your ticket / event
                                    </p>
                                </td>
                            </tr>
                        </tbody>
                        ...
                        <tbody>
                            <tr>
                                <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center"
                                    ...
                                    <p style="margin-top: 0px;margin-bottom: 0px; font-size: 18px; font-weight: 600">
                                        {{ $eventName }}
                                        New Order</p>
                                    <p style="margin-top: 0px;margin-bottom: 0px;">From {{ $username }}</p>
                                    <p style="margin-top: 0px;margin-bottom: 0px;"> {{ $email }} </p>

                                    <b
                                        style="margin-top: 25px;margin-bottom: 0px; text-align: left; display: block;">Invoices</b>
                                    ...
                                    <table class="table table-striped" style="width: 100%">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <hr />
                                                    <p style="margin-left: 20px; font-size: 14px; text-align: left;">
                                                        <b>Sub Total</b>
                                                    </p>
                                                </td>
                                                <td>
