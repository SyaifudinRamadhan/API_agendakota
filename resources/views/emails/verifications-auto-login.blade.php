                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="column column-1"
                                                    ...
                                                    width="100%">
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        class="image_block" role="presentation"public_path('storage')
                                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;"
                                                        width="100%">
                                                        <tr>
                                                            <td
                                                                    ...
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span
                                                                                ...
                                                                                registration has been successful. You
                                                                                are registered with email
                                                                                {{ $email }}. Use the password
                                                                                below to log in to our Agendakota.id
                                                                                website, if you want to access the
