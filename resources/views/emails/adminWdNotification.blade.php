...
<head>
    ...
    <title>Withdraw Verify Notification</title>
    <style type="text/css">
        a {
                        ...
                        <tbody>
                            <tr>
                                <td class="o_bg-ultra_light o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light"
                                    ...
                                    <p style="margin-top: 0px;margin-bottom: 0px;">Seorang user melakukan pengajuan
                                        penarikan keuangan dengan detail sebagai berikut</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                            ...
                            <tr>
                                <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center"
                                    ...
                                    <p style="margin-top: 0px;margin-bottom: 0px;">Admin Notification.
                                        User with username "{{ $username }}" and email "{{ $email }}",
                                        has submitted a withdrawal request
                                        with the following details. Immediately check the admin system to verify it.
